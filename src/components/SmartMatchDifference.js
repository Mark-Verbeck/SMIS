...
class SmartMatchDifference extends Component {
  ...
  render(){
    ...
    return(
      <div className="divPadding whiteBackground SmartMatchDiffDiv">
      <div className="wrap1">
        <h2 className="text-center pb-5"> The <strong>SmartMatch</strong> difference</h2>
        ...
        <MDBRow>
          ...
          <h3 className="pt-3">Personalized</h3>
          ...
          <h3 className="pt-3"><strong>SmartMatched</strong></h3>
